...
async function start() {
    ...
    console.log(`start  telegram, initData:`, telegram, initData)
    if (!telegram || !initData) {
        errorMessage.innerHTML = "Open this Mini App from <a target='_blank' href='https://t.me/weblink_shortener_bot'>@weblink_shortener_bot</a> in Telegram.";
        showOnly(errorPanel);
        return;
    }
...
document.querySelectorAll('.open-website-button').forEach((button) =>
    button.addEventListener("click", () => telegram.openLink(window.location.origin, { try_instant_view: true }))
);
